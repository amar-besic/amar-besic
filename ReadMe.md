...
<div style="display: flex; flex-direction: column; gap: 10px;">
  ...
  <div style="font-weight: bold; font-size: 18px; margin-bottom: 5px;">💻 Programming Languages</div>
  ...
  <!-- WEB DEVELOPMENT -->
  <div style="font-weight: bold; font-size: 18px; margin-bottom: 5px;">🌐 Web Development</div>
  <div style="display: flex; flex-wrap: wrap; gap: 5px;">
  ...
  <!-- OPERATING SYSTEMS -->
  <div style="font-weight: bold; font-size: 18px; margin-bottom: 5px;">🖥️ Operating Systems</div>
  <div style="display: flex; flex-wrap: wrap; gap: 5px;">
  ...
  <div style="font-weight: bold; font-size: 18px; margin-bottom: 5px;">🔄 Version Control & Databases</div>
  <div style="display: flex; flex-wrap: wrap; gap: 5px;">
  ...
  <div style="font-weight: bold; font-size: 18px; margin-bottom: 5px;">🛠️ CAD & Engineering Software</div>
  <div style="display: flex; flex-wrap: wrap; gap: 5px;">
  ...
  <!-- OFFICE SUITE -->
  <div style="font-weight: bold; font-size: 18px; margin-bottom: 5px;">📂 Microsoft Office Suite</div>
  <div style="display: flex; flex-wrap: wrap; gap: 5px;">
    <a href="#" onclick="return false;"><img src="https://img.shields.io/badge/Word-%232B579A.svg?style=for-the-badge&logo=microsoftword&logoColor=white" alt="Word"></a>
  ...
  <!-- CLOUD STORAGE -->
  <div style="font-weight: bold; font-size: 18px; margin-bottom: 5px;">☁️ Cloud Storage</div>
  <div style="display: flex; flex-wrap: wrap; gap: 5px;">
  ...
  <div style="font-weight: bold; font-size: 18px; margin-bottom: 5px;">🛠️ Software & Tools</div>
  <div style="display: flex; flex-wrap: wrap; gap: 5px;">
